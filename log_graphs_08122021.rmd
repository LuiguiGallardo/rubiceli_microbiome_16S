...
```{r, echo=FALSE, warning=FALSE, include=FALSE}
# Input table
beta_data <- read.table(file = "03_beta_diversity/01_nd_vs_hfd/unweighted_unifrac_r_pc.txt",
                         header = TRUE,
                         sep = "\t")
...
# PCoA plot
pcoa_unweighted <- ggplot(beta_data, aes(x = pc1_0.490934671745,
                                              y = pc2_0.165542897875)) +
...
```{r, echo=FALSE, warning=FALSE, include=FALSE}
# Input table
beta_data <- read.table(file = "03_beta_diversity/03_nd_vs_hfd_env/unweighted_unifrac_r_pc.txt",
                         header = TRUE,
                         sep = "\t")
